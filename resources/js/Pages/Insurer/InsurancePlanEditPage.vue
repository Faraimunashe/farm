<template>
  <Head title="Edit Insurance Plan" />

  <div class="space-y-6">
    <div class="flex justify-between items-center">
      <div>
        <h1 class="text-2xl font-bold text-gray-900">Edit Insurance Plan</h1>
        <p class="text-gray-600">Update comprehensive plan information</p>
      </div>
      ...
      <form @submit.prevent="submitForm" class="space-y-6">
        ...
        <div class="flex justify-end space-x-4">
          ...
          >
            ...
            <span v-if="!loading">Update Plan</span>
...
const form = useForm({
  ...
  coverage_type: props.plan.coverage_type || '',
  coverage_percentage: props.plan.coverage_percentage || '',
  premium_rate: props.plan.premium_rate || '',
  min_coverage: props.plan.min_coverage || '',
  max_coverage: props.plan.max_coverage || '',
  duration_months: props.plan.duration_months || '',
  deductible_amount: props.plan.deductible_amount || '',
  terms_conditions: props.plan.terms_conditions || '',
...
const submitForm = () => {
  loading.value = true
  form.put(`/insurer/plans/${props.plan.id}`, {
    onFinish: () => {
      loading.value = false
    }
  })
